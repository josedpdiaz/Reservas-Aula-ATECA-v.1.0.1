...
export const notifyTestEmail = async (usuario: Usuario) => {
  return dispatchNotificationEmail({
    ...
    `,
    contentText: `Hola ${usuario.nombre}. Te escribimos desde la administración de la plataforma del Aula ATECA: Por favor, dado que tu sesión ha finalizado, no olvides rellenar el formulario para cumplimentar la valoración didáctica y la memoria de uso. Es un pequeño formulario para rellenar en dos minutos. Gracias. 💡 Indicación si el botón no responde: «Si el botón no te funciona, entra de nuevo al gestor de reservas de la ATECA en el que hiciste la reserva en su momento (https://ateca.fpapps.es), busca la actividad en la sección «Mis Actividades» y pulsa en el botón con fondo negro y letras blancas el que se indica "Completar Valoración", para realizar el breve formulario de valoración de la actividad realizada en nuestra aula ATECA.»`,
    details: [
...
export const notifyRecordatorioValoracion = async (reserva: Reserva, usuario: Usuario) => {
  return dispatchNotificationEmail({
    ...
    contentHtml: `
      ...
      <p style="font-size: 12px; color: #64748b; margin-top: 10px;"><em>Administradores de la plataforma · Aula ATECA · IES Agustín de Betancourt</em></p>
    `,
    contentText: `Hola ${usuario.nombre}. Te escribimos desde la administración de la plataforma del Aula ATECA: Por favor, dado que tu sesión ha finalizado, no olvides rellenar el formulario para cumplimentar la valoración didáctica y la memoria de uso. Es un pequeño formulario para rellenar en dos minutos. Gracias. Sesión: ${reserva.modulo_materia_area} (${reserva.grupo}), ${reserva.fecha_actividad} de ${reserva.hora_inicio} a ${reserva.hora_fin}. 💡 Indicación si el botón no responde: «Si el botón no te funciona, entra de nuevo al gestor de reservas de la ATECA en el que hiciste la reserva en su momento (https://ateca.fpapps.es), busca la actividad en la sección «Mis Actividades» y pulsa en el botón con fondo negro y letras blancas el que se indica "Completar Valoración", para realizar el breve formulario de valoración de la actividad realizada en nuestra aula ATECA.»`,
    details: [
      { label: 'Docente', value: usuario.nombre },
