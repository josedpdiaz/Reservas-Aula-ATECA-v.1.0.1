        ...
        {!user ? (
          <div className="max-w-md mx-auto space-y-6 pt-10 no-print">
            <div className="bg-white border border-slate-200 p-8 rounded-2xl shadow-xl space-y-6 text-center">
              {config.logo_centro ? (
                <div className="h-20 max-w-[240px] bg-white border border-slate-200/80 rounded-2xl flex items-center justify-center mx-auto shadow-xs px-4 py-2 overflow-hidden">
                  <img src={config.logo_centro} alt="Logo IES Agustín de Betancourt" className="h-full w-auto object-contain" />
                </div>
              ) : (
